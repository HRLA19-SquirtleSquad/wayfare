...
export const createSeedUsers = async () => {
  ...
  try{
    ...
    let query = "insert into users values (DEFAULT, 'Brian Hong', 'briguy@aol.com', 'asdfi34309', 'hi, im brian', 'https://www.google.com/imgres?imgurl=https://assets.pokemon.com/assets/cms2/img/pokedex/detail/043.png&imgrefurl=https://www.pokemon.com/us/pokedex/oddish&h=215&w=215&tbnid=WrwAjzyZuIzfJM:&tbnh=186&tbnw=186&usg=__CSzNNoD5rLyNQI3NT7NIN5qNubI%3D&vet=10ahUKEwj8oceH24LZAhUH7mMKHdEdCP0Q_B0ItAEwEw..i&docid=49mknwwZxyCNfM&itg=1&sa=X&ved=0ahUKEwj8oceH24LZAhUH7mMKHdEdCP0Q_B0ItAEwEw', 'LA', 1, 3.2, 12, 0, 0)"
    await db.queryAsync(query)
    console.log('user seed data 3 inserted'); 
  } catch (err) {
    console.log('user seed data 3 did not insert', err)
  }try{
    let query = "insert into users values (DEFAULT, 'ErIc Carmona', 'BballinEric@lakers.com', 'sdiwef23r8nv', 'hi, im erIc', 'https://www.google.com/imgres?imgurl=https://cdn-s3.si.com/s3fs-public/teams/basketball/nba/players/214152-300x300.png&imgrefurl=https://www.si.com/nba/player/214152/lebron-james&h=300&w=300&tbnid=Um0-ny3STqIOgM:&tbnh=186&tbnw=186&usg=__mS80Wbc4A7om2qWHMAX-4jeAL6s%3D&vet=10ahUKEwi2pfC83ILZAhVNwWMKHcnjDskQ_B0IwAEwHA..i&docid=l9fHBl84MfA_GM&itg=1&sa=X&ved=0ahUKEwi2pfC83ILZAhVNwWMKHcnjDskQ_B0IwAEwHA', 'LA', 1, .01, 14, 5, 22)"
    await db.queryAsync(query)
