...
export const createSeedUsers = async () => {
   try{
       let query = "insert into users values (DEFAULT, 'Danieo Sanchez', 'damndanieo@skynet.com', 'asdj4569ssf90', 'https://media.mnn.com/assets/images/2015/09/river-otters-lead-photo.jpg.638x0_q80_crop-smart.jpg', 'LA', 0, 0, 0, 0.05, 323)"
   ...
   try{
        let query = "insert into users values (DEFAULT, 'Chris King-Kong', 'emergency@poopvan.com', 'asdf823r9asd', 'https://images-na.ssl-images-amazon.com/images/I/513Y54TGdwL._SY445_.jpg', 'LA', 0, 0, 0, 2.2, 43)"
        await db.queryAsync(query)
